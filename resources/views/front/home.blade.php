<x-front-layout>
    {{-- <x-slot name="breadcrumbs"> --}} {{-- old way --}}
        {{-- <x-slot:breadcrumbs> {{-- new way
                    ...
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider"
                                style="background-image: url('{{ asset('assets/images/placeholders/800_500.png') }}');">
                                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                            ...
                            <div class="hero-small-banner"
                                style="background-image: url('{{ asset('assets/images/placeholders/370_250.png') }}');">
                                <div class="content">
                                    <h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{ asset('assets/images/placeholders/180_180.png') }}" alt="placeholder">
                        </div>
                    </div>
                    <!-- End Single Category -->
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{ $product->image_path }}" alt="placeholder" height="200" width="auto">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner"
                        style="background-image:url('{{ asset('assets/images/placeholders/620_340.png') }}');">
                        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="single-product">
                                <div class="product-image">
                                    <img src="{{ asset('assets/images/placeholders/335_335.png') }}" alt="placeholder">
                                    <div class="button">
                    ...
                    <div class="single-banner right"
                        style="background-image:url('{{ asset('assets/images/placeholders/730_310.png') }}');margin-top: 30px;">
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="offer-content">
                        <div class="image">
                            <img src="{{ asset('assets/images/placeholders/510_600.png') }}" alt="placeholder">
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img
                                    src="{{ asset('assets/images/placeholders/100_100.png') }}" alt="placeholder"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html">
                                <img src="{{ asset('assets/images/placeholders/100_100.png') }}" alt="placeholder">
                            </a>
                        </div>
                        <div class="list-info">
                            <h3>
            ...
            <div class="brands-logo-wrapper">
                <div class="brands-logo-carousel d-flex align-items-center justify-content-between">
                    <div class="brand-logo">
                        <img src="{{ asset('assets/images/placeholders/220_160.png') }}" alt="placeholder">
                    </div>
                    <div class="brand-logo">
                        <img src="{{ asset('assets/images/placeholders/220_160.png') }}" alt="placeholder">
                    </div>
                    ...
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="blog-single-sidebar.html">
                                <img src="{{ asset('assets/images/placeholders/370_215.png') }}" alt="placeholder">
                            </a>
                        </div>
